...
import type { BoardPromotionContextState } from '../../../types';
...
const PromotionDialog: React.FC<Required<BoardPromotionContextState>> =
  React.memo(({ type, onSelect }) => {
    ...
    //const [promotionDialogLocation, setPromotionDialogLocation] = useState({ left: boardSize / 3, top: boardSize / 3})
    ...
    return (
      <Animated.View
        ...
        style={[
          ...
          styles.container,
          //promotionDialogLocation
        ]}
        /*onLayout={(event) => {
					const layout = event.nativeEvent.layout;
					setPromotionDialogLocation({
						left: layout.x + boardSize / 2,
						top: layout.y - boardSize / 2
					})
				}}*/
      >
